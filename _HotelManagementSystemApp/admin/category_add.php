...
<nav class="w3-sidebar w3-animate-left w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
      ...
      <a href="company_service.php?company_id=<?php echo $_GET["company_id"]; ?>" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Back to Services</a>
  ...
  <div class="w3-container" style="margin-top:80px" id="showcase">
    ...
    <form id="category-form" method="POST">
        ...
        <div class="w3-section">
            ...
            <input placeholder="Category name" class="w3-input w3-round-xlarge w3-border" type="text" name="category_name" required="">
        </div>
        <button type="button" onclick="admin.services.addCategory(this)" class="w3-button w3-round-large w3-block w3-padding-large w3-red w3-margin-bottom">Add new category</button>
    </form>
