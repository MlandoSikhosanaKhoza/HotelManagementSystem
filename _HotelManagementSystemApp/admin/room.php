        ...
        <?php
            ...
            if (isset($_COOKIE["admin_user"]) && isset($_COOKIE["admin_uid"]) && isset($_GET["company_id"])) {
                ...
                if ($admin_id>0) {
                    ...
                    $list_room_nums=$acc->getRoomNums($_GET["company_id"]);
                }else{
...
<nav class="w3-sidebar w3-animate-left w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
      ...
      <a href="room_num.php?company_id=<?php echo $_GET["company_id"]; ?>" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Add room number</a>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px;min-height: 400px;">
  ...
  <div class="w3-container" style="margin-top:80px" id="showcase">
    ...
    <?php for ($index = 0; $index < count($list_room_nums); $index++) {
                ?>
                   <div class="w3-col l4 m6 s12" style="padding: 8px;">
            <div class="w3-border w3-center w3-round-xxlarge" style="min-height: 250px;padding: 16px;">
                <h4>Room: <?php echo $list_room_nums[$index]->RoomNum; ?></h4>
                <h5 class="w3-tag w3-round-medium w3-red"><?php echo $list_room_nums[$index]->RoomName; ?></h5>
