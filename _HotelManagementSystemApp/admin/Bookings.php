<html>
    <head>
        <?php
            include '../App_Data/Booking_Admin.php';
            include 'header.php';
            $acc=new Booking_Admin();
...
<nav class="w3-sidebar w3-animate-left w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
      <a href="index.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Back to Home</a>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px;min-height: 400px;">
  ...
  <div class="w3-container" style="margin-top:80px" id="showcase">
    ...
    <h1 class="w3-xxxlarge w3-text-red"><b>Bookings</b></h1>
    <h3><?php echo $companyname; ?></h3>
    <hr style="width:50px;border:5px solid red" class="w3-round">
    <div class="w3-col s12" style="padding: 8px;">
        <div class="w3-border w3-container w3-center w3-round-large" style="min-height: 300px;padding: 16px;">
            <h3>Bookings</h3>
            <?php echo $acc->getBookingsHTML($_GET["company_id"]); ?>
            <div class="w3-center w3-hide w3-round-xlarge w3-red" style="padding: 5px;">
                <h3>Customer name</h3>
                <h4>Room number: 5</h4>
    ...
    <div class="w3-col s12 w3-hide" style="padding: 8px;">
        <div class="w3-border w3-center w3-round-large" style="height: 300px;padding: 16px;">
            <h3>Upcoming (Within 3 days)</h3>
            
        </div>
    </div>
    <div class="w3-col s12 w3-hide" style="padding: 8px;">
        <div class="w3-border w3-center w3-round-large" style="height: 300px;padding: 16px;">
            <h3>Much Later (1 month)</h3>
