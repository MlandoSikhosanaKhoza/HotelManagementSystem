...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:80px" id="showcase">
    ...
    <h1 class="w3-xxxlarge w3-text-red"><b>Add new company</b></h1>
    <hr style="width:50px;border:5px solid red" class="w3-round">
    <form id="company-form" method="POST">
      <div class="w3-section">
        <label>Company name</label>
        <input placeholder="Company name" class="w3-input w3-round-xlarge w3-border" type="text" name="companyname" required="">
      </div>
      <div class="w3-section">
        <label>Address</label>
        <input placeholder="Address" class="w3-input w3-round-xlarge w3-border" type="text" name="address" required="">
      </div>
      <div class="w3-section">
        <label>City</label>
        <input placeholder="City" class="w3-input w3-round-xlarge w3-border" type="text" name="city" required="">
      </div>
        <div class="w3-section">
        <label>Postal code</label>
        <input placeholder="Postal Code" class="w3-input w3-round-xlarge w3-border" type="number" name="postalcode" required="">
      </div>
      <div class="w3-section">
        <label>Email</label>
        <input placeholder="Email" class="w3-input w3-round-xlarge w3-border" type="text" name="email" required="">
      </div>
      <div class="w3-section">
        <label>Username</label>
        <input placeholder="Username" class="w3-input w3-round-xlarge w3-border" type="text" name="username" required="">
      </div>
      <div class="w3-section">
        <label>Password</label>
        <input placeholder="Password" class="w3-input w3-round-xlarge w3-border" type="password" name="password" required="">
      </div>
        <div class="w3-section">
        <label>Confirm password</label>
        <input placeholder="Confirm password" class="w3-input w3-round-xlarge w3-border" type="password" name="confirmPassword" required="">
      </div>
        <button type="button" onclick="admin.addNewCompany(this)" class="w3-button w3-round-large w3-block w3-padding-large w3-red w3-margin-bottom">Create New Company</button>
    </form>
