    ...
    <head>
        <?php
            ...
            if (isset($_COOKIE["admin_user"]) && isset($_COOKIE["admin_uid"])) {
                $acc=new Admin();
                if ($acc->verify($_COOKIE["admin_user"]."", $_COOKIE["admin_uid"]."")) {
  ...
  <div>
      <form id="login-form" class="w3-container">
        <div class="w3-section">
          ...
          <button onclick="admin.login(this)" class="w3-button w3-block w3-padding-large w3-red w3-round-large w3-section w3-padding" type="submit">Login</button>
...
<div  class="w3-container w3-hide">
    ...
    <form id="signup-form">
      ...
      <div class="w3-section">
        ...
        <button onclick="admin.signup(this)" type="button" class="w3-button w3-round-large w3-block w3-padding-large w3-red w3-margin-bottom">Sign up</button>
    </form>
</div>
</div>
